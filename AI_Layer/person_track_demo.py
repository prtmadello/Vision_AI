#!/usr/bin/env python3
"""
Person Recognition Demo:
- Detects faces in video
- Recognizes known vs unknown persons using face vectors
- Tracks person identities across frames
- Streams recognition data to Kafka
"""
...
def main():
    ...
    try:
        ...
        try:
            ...
            topic = cfg.get('kafka', {}).get('person_recognition_topic', 'person_recognition')
    ...
    print(f"Processing video (person recognition): {video_path}")
    ...
    print("Person recognition result:", result)
